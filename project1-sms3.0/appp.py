...
font = {'font': ('Comic Sans MS', 11)}
entry_font = {'font': ('Comic Sans MS', 11, 'italic')}
...
lb=LabelFrame(main, text='Login',background="#851e3e", fg='#FDD7E4')
lb.pack()
#Login page
uidl = Label(lb, text='Username', **font,background="#851e3e",fg='#FFFFFF')
uidl.grid(column=0, row=0, **paddings)

uid = Entry(lb, width=25, **entry_font)
uid.grid(column=1, row=0, **paddings)

pwdl = Label(lb, text='Password', **font,background="#851e3e",fg='#FFFFFF')
...
def rec_show():
    ...
    lbframe = LabelFrame(top2, text='Records',background='#FF5050',fg='#FFD3F8')
    lbframe.pack()
    ...
    lbframen = LabelFrame(top2, text='More Options',background='#FF5050')
    lbframen.pack()
    srch=Label(lbframen, text='Search', **font,background='#FF5050')
    ...
    srchbtn = Button(lbframen, text="Search", command=srch,background='#FC5A8D')
...
def rec_shows():
    ...
    lbframe = LabelFrame(top3, text='Records',background='#FF5050',fg='#FFD3F8')
    lbframe.pack()
    txt_box = ScrolledText(lbframe)
    txt_box.configure(wrap='word')
    txt_box.insert(END, txt1)
    ...
    lbframen = LabelFrame(top3, text='More Options',background='#FF5050')
    lbframen.pack()
    srch=Label(lbframen, text='Search', **font,background='#FF5050')
    srch.grid(column=0, row=0, **paddings)
    search_box=Entry(lbframen, width=19, **entry_font,)
...
def rec_del():
    top3=Toplevel(main)
    lb1 = LabelFrame(top3, text='Modify Records')#background='#ADEFD1FF')
    lb1.pack()
    ent = Entry(lb1, width=19, **entry_font)#background='#00203FFF')
    ...
    delbtn = Button(lb1, text='Delete', command=delr)#,background='#E7ACCF')
    delbtn.grid(column=0, row=1, **paddings)


lbframe2=LabelFrame(main, text='Options',background="#851e3e",fg='#FDD7E4')
...
#
lbframe3=LabelFrame(main, text='Options',background="#851e3e",fg='#FDD7E4')
